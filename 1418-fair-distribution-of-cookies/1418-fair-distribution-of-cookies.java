class Solution {
    ...
    // zeroCount represent number of children with no cookies.
    // distribute array represent the number of cookies each child contains after fair distribution.


    public int dfs(int i, int[] distribute, int[] cookies, int k, int zeroCount) {
